...
process = []
client_path = os.path.abspath(os.path.join(os.path.dirname(__file__), './client_dist/'))
server_path = os.path.abspath(os.path.join(os.path.dirname(__file__), './server_dist/'))
